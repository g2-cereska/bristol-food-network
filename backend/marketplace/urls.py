...
urlpatterns = [
    ...
    path('products/<int:pk>/reviews/', ProductReviewListCreateView.as_view()),
    ...
    path('settlements/<int:producer_id>/export/', SettlementCsvExportView.as_view()),
